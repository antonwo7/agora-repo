...
Redux::set_section( $opt_name, [
		...
		'fields' => [
			...
			[
				'id'      => '_enable-agents',
				'type'    => 'switch',
				'title'   => __( 'Enable Agents', 'lisfinity-core' ),
				'desc'    => __( 'Choose if you wish to enable usage of the agents', 'lisfinity-core' ),
				'default' => false,
			],
			[
				'id'      => '_enable-user-verification',
				'type'    => 'switch',
				'title'   => __( 'Enable User Verification', 'lisfinity-core' ),
				'desc'    => __( 'Choose if you wish to enable documented user verification', 'lisfinity-core' ),
				'default' => false,
			],
		],
	]
...
Redux::set_section( $opt_name, [
	...
	'fields'     => [
		...
		[
			'id'      => '_checkout-vat-mandatory',
			'type'    => 'switch',
			'title'   => __( 'Make VAT field mandatory', 'lisfinity-core' ),
			'desc'    => __( 'Choose if you wish to make the VAT field mandatory for the user', 'lisfinity-core' ),
			'default' => true,
		],
		[
			'id'       => '_checkout-vat-label',
			'type'     => 'text',
			'title'    => __( 'VAT field label', 'lisfinity-core' ),
			'desc'     => __( 'Change "VAT" label to something else, like "GST" if you are in Australia, for example.', 'lisfinity-core' ),
			'default'  => 'VAT',
			'required' => [ '_checkout-vat', '=', '1' ],
		],
		[

		...
		$fields = [
			...
			'general'    => [
				...
				'_phone'      => [
					...
					'type'       => 'text',
					'attributes' => [
						'placeholder' => ! empty( lisfinity_get_option( 'auth-phone-placeholder' ) ) ? lisfinity_get_option( 'auth-phone-placeholder' ) : __( 'Type phone...', 'lisfinity-core' )
					],
				],
				'_website'    => [
					'key'        => $count ++,
			...
			'media'      => [
				'_product_image_gallery' => [
					...
					'minimum_limit'   => lisfinity_get_option( 'product-minimum-required-images' ) ?? 0,
					'multiple'        => true,

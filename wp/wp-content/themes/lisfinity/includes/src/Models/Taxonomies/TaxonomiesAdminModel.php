...
class TaxonomiesAdminModel {
		...
		$fields = [
			...
			'general' => [
				...
				'active'      => [
					...
					'value'       => '',
					'description' => __( 'Choose if the taxonomy is active and available on the site', 'lisfinity-core' ),
					'type'        => 'select',
					'choices'     => [
						'yes' => __( 'Yes', 'lisfinity-core' ),
						'no'  => __( 'No', 'lisfinity-core' ),
	 ...
	 * @return array
	 */
	public function format_taxonomy_for_select( $taxonomy, bool $multiple = false ) {
		$select = [];
		if ( ! $multiple ) {
